...
module Stellar
  ...
  autoload :SCValType
  autoload :SCStatusType
  autoload :SCHostValErrorCode
  autoload :SCHostObjErrorCode
  autoload :SCHostFnErrorCode
  autoload :SCHostStorageErrorCode
  autoload :SCHostAuthErrorCode
  autoload :SCHostContextErrorCode
  autoload :SCVmErrorCode
  autoload :SCUnknownErrorCode
  autoload :SCStatus
  autoload :Int128Parts
  autoload :SCContractExecutableType
  autoload :SCContractExecutable
  autoload :SCAddressType
  autoload :SCAddress
  SCVAL_LIMIT = 256000
  SCSYMBOL_LIMIT = 32
  SCVec = XDR::VarArray[SCVal, SCVAL_LIMIT]
  SCMap = XDR::VarArray[SCMapEntry, SCVAL_LIMIT]
  SCBytes = XDR::VarOpaque[SCVAL_LIMIT]
  SCString = XDR::String[SCVAL_LIMIT]
...
module Stellar
  ...
  autoload :ContractIDType
  autoload :ContractIDPublicKeyType
  autoload :InstallContractCodeArgs
  autoload :ContractID
  autoload :CreateContractArgs
  autoload :HostFunction
  autoload :AuthorizedInvocation
  autoload :AddressWithNonce
...
module Stellar
  ...
  autoload :TransactionResultPairV2
  autoload :TransactionResultSetV2
  autoload :TransactionHistoryResultEntryV2
  ...
  autoload :OperationDiagnosticEvents
  autoload :OperationEvents
  autoload :TransactionMetaV3
  autoload :TransactionMeta
  autoload :TransactionResultMeta
  autoload :TransactionResultMetaV2
